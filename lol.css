...
:root {
    ...
    --homeImage: url('https://limeshark.dev/img/bdi/n8h.png');
    --homeImageSize: cover;
    --backgroundColor: #0d0d0d;
    --backgroundImage: url('https://thumbs.gfycat.com/PeriodicChubbyGlassfrog-size_restricted.gif');
...
.tutorialContainer-2sGCg9 .childWrapper-anI2G9 .homeIcon-tEMBK1 {
    display: none
}
...
.selected-aXhQR6 .layout-2DM8Md::before {
    content: "";
    position: absolute;
    left: -1px;
    top: 0;
...
.pageControlContainer-3czZwE .lookFilled-1Gx00P.colorTransparent-1ewNp9 {
    background-color: var(--backgroundColor);
    box-shadow: 0 2px 15px 0 rgba(0, 0, 0, .7)
}

.pageControlContainer-3czZwE .lookFilled-1Gx00P.colorTransparent-1ewNp9:disabled {
    background-color: var(--backgroundColor);
    opacity: .85
}

.pageControlContainer-3czZwE .lookFilled-1Gx00P.colorTransparent-1ewNp9:hover {
    background-color: var(--backgroundColor);
...
.actions-pBaxX6 .action-1lSjCi .colorStandard-2KCXvj {
...
.wrapper-2jXpOf .icon-WnO6o2,
.wrapper-2jXpOf .name-IbjUBS,
.wrapper-2jXpOf.muted-1NRuDm:hover .icon-WnO6o2,
.wrapper-2jXpOf.muted-1NRuDm:hover .name-IbjUBS,
.wrapper-2jXpOf:hover .icon-WnO6o2,
.wrapper-2jXpOf:hover .name-IbjUBS {
    color: var(--themeColor1);
...
.containerDefault--pIXnN.selected-37j_iU .modeSelected-346R90 .content-1x5b-n,
.containerDefault--pIXnN.selected-37j_iU .modeSelected-346R90:hover .content-1x5b-n,
...
.containerDefault--pIXnN.selected-37j_iU .modeSelected-346R90 .content-1x5b-n::before,
.modeSelected-346R90 .content-1x5b-n::before,
.modeSelected-346R90:hover .content-1x5b-n::before {
    content: "";
    position: absolute;
    left: -1px;
    top: 0;
...
.tooltipGrey-1hnvTt .tooltipPointer-3ZfirK {
...
.unreadPillCap-3_K2q2 .unreadPillCapStroke-7rkHbg {
    color: var(--themeColor1);
...
.membersGroup-v9BXpm::after,
.membersGroup-v9BXpm::before {
    content: "";
    position: absolute;
    width: 50%;
    height: 100%;
...
.row-rrHHJU.selected-1pIgLL span,
.row-rrHHJU:hover span {
...
.activityProfile-2bJRaP .content-3JfFJh,
.activityProfile-2bJRaP .details-38sfDr,
.activityProfile-2bJRaP .headerText-1HLrL7,
.activityProfile-2bJRaP .name-29ETJS,
.activityUserPopout-2yItg2 .content-3JfFJh,
.activityUserPopout-2yItg2 .details-38sfDr,
.activityUserPopout-2yItg2 .headerText-1HLrL7,
.activityUserPopout-2yItg2 .name-29ETJS {
...
div[aria-label=GUILD_SETTINGS] .side-8zPYf6 .item-PXvHYJ:hover {
    padding-left: 15px
}
...
div[aria-label=GUILD_SETTINGS] .side-8zPYf6 .themed-OHr7kt.selected-3s45Ha.item-PXvHYJ,
div[aria-label=GUILD_SETTINGS] .topPill-30KHOu .themed-OHr7kt.selected-3s45Ha.item-PXvHYJ {
    padding-left: 25px
}
...
.topPill-30KHOu .themed-OHr7kt.selected-3s45Ha.item-PXvHYJ::after {
    content: "";
    position: absolute;
    left: 0;
    top: 0;
...
.side-8zPYf6 .header-2RyJ0Y::after,
.side-8zPYf6 .header-2RyJ0Y::before {
    content: "";
    position: absolute;
    width: 50%;
    height: 100%;
...
.container-3auIfb[style*="rgb(59, 165, 92)"] {
...
.checkboxWrapper-SkhIWG .checkbox-1ix_J3.checked-3_4uQ9 {
    background-color: var(--themeColor1) !important;
    background-image: linear-gradient(to bottom right, var(--themeColor1), var(--themeColor2));
...
.item-26Dhrx[style*="rgb(114, 137, 218)"] .checkboxWrapper-SkhIWG .checkbox-1ix_J3.checked-3_4uQ9 {
    border-color: rgba(0, 0, 0, .5) !important;
    background-color: var(--backgroundColor) !important;
    background-image: none !important
}

.item-26Dhrx[style*="rgb(114, 137, 218)"] .checkboxWrapper-SkhIWG .checkbox-1ix_J3.checked-3_4uQ9 svg g polyline {
    stroke: var(--themeColor1) !important
}

.cardPrimaryEditable-3KtE4g[style*="rgb(67, 181, 129)"] {
    background-color: #43b581 !important;
    background-image: linear-gradient(to top right, #44b566, #43b581) !important;
    border-color: rgba(0, 0, 0, .95) !important
}

.checkboxWrapper-SkhIWG .checkbox-1ix_J3[style*="rgb(67, 181, 129)"] {
    background-image: none !important;
    background-color: #fff !important;
    border-color: rgba(0, 0, 0, .15) !important
}

.cardPrimaryEditable-3KtE4g[style*="rgb(250, 166, 26)"] {
    background-color: #faa61a !important;
    background-image: linear-gradient(to top right, #fb8a1a, #faa61a) !important;
    border-color: rgba(0, 0, 0, .95) !important
}

.checkboxWrapper-SkhIWG .checkbox-1ix_J3[style*="rgb(250, 166, 26)"] {
    background-image: none !important;
    background-color: #fff !important;
    border-color: rgba(0, 0, 0, .15) !important
}

.cardPrimaryEditable-3KtE4g[style*="rgb(245, 119, 49)"] {
    background-color: #f04747 !important;
    background-image: linear-gradient(to top right, #f54430, #f57731) !important;
    border-color: rgba(0, 0, 0, .95) !important
}

.checkboxWrapper-SkhIWG .checkbox-1ix_J3[style*="rgb(245, 119, 49)"] {
    background-image: none !important;
    background-color: #fff !important;
    border-color: rgba(0, 0, 0, .15) !important
}

.cardPrimaryEditable-3KtE4g[style*="rgb(240, 71, 71)"] {
    background-color: #f04747 !important;
    background-image: linear-gradient(to top right, #f06c46, #f04747) !important;
    border-color: rgba(0, 0, 0, .95) !important
}

.checkboxWrapper-SkhIWG .checkbox-1ix_J3[style*="rgb(240, 71, 71)"] {
    background-image: none !important;
    background-color: #fff !important;
    border-color: rgba(0, 0, 0, .15) !important
}
...
.backgroundFlash-24qWLN .wrapper-3WhCwL {
    box-shadow: none
}
...
.tabBar-ZmDY9v .item-3HknzM[style*="rgb(67, 181, 129)"] {
    background-color: var(--themeColor1);
    background-image: linear-gradient(to right, var(--themeColor1), var(--themeColor2));
    color: #fff !important
}
...
.peopleListItem-2nzedh.active-rhSpJJ .actionButton-uPB8Fs.highlight-Lf97TE,
.peopleListItem-2nzedh:hover .actionButton-uPB8Fs.highlight-Lf97TE {
    background-color: var(--backgroundColor);
    box-shadow: inset 0 0 0 1000000px rgba(255, 255, 255, .05)
}
...
.ddrArrows-lSnH7P .arrow-2enltQ:nth-child(1) {
    filter: hue-rotate(60deg)
}

.ddrArrows-lSnH7P .arrow-2enltQ:nth-child(2) {
    filter: hue-rotate(120deg)
}

.ddrArrows-lSnH7P .arrow-2enltQ:nth-child(3) {
    filter: hue-rotate(180deg)
}

.ddrArrows-lSnH7P .arrow-2enltQ:nth-child(4) {
...
.searchResultsWrap-3-pOjs div[role=group] .channelSeparator-dTqJ4K:before {
    content: none
}

.searchResultsWrap-3-pOjs div[role=group] .channelName-wvgELL {
...
.childWrapper-anI2G9 .homeIcon-FuNwkv {
    display: none
}
...
.avatar-1uQSZT,
.subscriptionsRedirectContainer-21LuI0,
.notice-2OK8bw,
...
#bd-settings-sidebar .ui-tab-bar-header, .side-8zPYf6 .header-2RyJ0Y {
    width: 100%;
}
